...
def get_kokoro_path() -> str:
    ...
    return os.path.expanduser("~/.claudeclaw/tools/kokoro")


def get_ml_env_path() -> str:
    """Get the path to shared ML environment."""
    return os.path.expanduser("~/.claudeclaw/tools/ml-env")
...
def get_pandoc_path() -> str:
    ...
    return os.path.expanduser("~/.claudeclaw/tools/pandoc/pandoc")
...
def install_pandoc() -> bool:
    ...
    tools_dir = os.path.expanduser("~/.claudeclaw/tools/pandoc")
...
def get_ytdlp_path() -> str:
    ...
    return os.path.expanduser("~/.claudeclaw/tools/yt-dlp/yt-dlp")
...
def install_ytdlp() -> bool:
    ...
    Installation location: ~/.claudeclaw/tools/yt-dlp/yt-dlp
    ...
    tools_dir = os.path.expanduser("~/.claudeclaw/tools/yt-dlp")
    os.makedirs(tools_dir, exist_ok=True)
...
def install_mlx_audio() -> bool:
    """Install mlx-audio in a dedicated venv at ~/.claudeclaw/tools/mlx-audio/.
    ...
    mlx_dir = os.path.expanduser("~/.claudeclaw/tools/mlx-audio")
...
def install_kokoro() -> bool:
    ...
    Creates ~/.claudeclaw/tools/kokoro/.venv with kokoro + torch.
        ...
        for upgrade in missing_upgrades:
            ...
            if upgrade.get("brew") and upgrade.get("standalone_installer"):
                ...
                if prompt_yn(f"\n    Install {upgrade['name']}?"):
                    ...
                    print("      2. Standalone binary (~/.claudeclaw/tools/)")
